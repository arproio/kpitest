CREATE OR REPLACE FUNCTION public.asset_alarmtimesum_realtime(value_stream_name character varying, stream_name character varying, machine_id character varying, property_names character varying[], start_time_string character varying, end_time_string character varying, shiftname character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$

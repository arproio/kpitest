CREATE OR REPLACE FUNCTION public.asset_kpi(value_stream_name character varying, machine_id character varying, end_time_string character varying, duration_in_sec integer, idea_run_rate integer)
 RETURNS record
 LANGUAGE plpgsql
 STABLE
AS $function$

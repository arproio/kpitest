CREATE OR REPLACE FUNCTION public.asset_kpi_bytime_batch_vr8600e(value_stream_name character varying, machine_ids character varying[], start_time_string character varying, end_time_string character varying, shift_start_time character varying, ideal_run_rate integer, capacity_potential_window real, throughput_window real, efficiency_window real, availability_window real)
...
BEGIN
	...
	LOOP
		...
		for myAVERAGE,myCYCLECOUNT,myPRODUCTCOUNT,myTHROUGHPUT,myAVAILABILITY,myCAPACITYPOTENTIAL,myEFFICIENCY,mySTARTTIME,myENDTIME,myMACHINEID in
			...
			from asset_kpi_bytime_vr8600e(value_stream_name,machine_id,start_time_string,end_time_string, shift_start_time, ideal_run_rate, capacity_potential_window, throughput_window, efficiency_window, availability_window) onemachine
		LOOP
			AVERAGE := myAVERAGE;

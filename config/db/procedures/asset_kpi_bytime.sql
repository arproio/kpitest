CREATE OR REPLACE FUNCTION public.asset_kpi_bytime(value_stream_name character varying, machine_id character varying, start_time_string character varying, end_time_string character varying, idea_run_rate integer)

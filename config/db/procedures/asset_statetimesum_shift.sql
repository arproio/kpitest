CREATE OR REPLACE FUNCTION public.asset_statetimesum_shift(value_stream_name character varying, stream_name character varying, machine_id character varying, par_property_name character varying, expected_value integer, target_name character varying, start_time_string character varying, end_time_string character varying, shiftname character varying)
 RETURNS void
 LANGUAGE plpgsql
AS $function$

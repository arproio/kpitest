CREATE OR REPLACE FUNCTION public.asset_kpi_bytime_vr86001x(value_stream_name character varying, machine_id character varying, start_time_string character varying, end_time_string character varying, shift_start_time character varying, ideal_run_rate integer, capacity_potential_window real, throughput_window real, efficiency_window real, availability_window real)
